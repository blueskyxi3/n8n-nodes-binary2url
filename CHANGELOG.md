...
#### [0.0.9](https://cnb.cool/ksxh-wwrs/n8n-nodes-binary-to-url/compare/0.0.7...0.0.9)
...
- refactor(BinaryToUrl): 重构文件上传URL生成逻辑 [`5d95573`](https://cnb.cool/ksxh-wwrs/n8n-nodes-binary-to-url/commit/5d9557306d3f1c65b6c742225baf72d256958950)
